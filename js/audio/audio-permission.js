...
export function openDenyModal()
{
    ...
    const text = /*html*/`
        ...
        <p>
            Pour que tous les outils fonctionnent à nouveau, veuillez ouvrir l'application dans votre navigateur, et
            autoriser manuellement l'accès au microphone ou réinitialiser toutes les autorisations.
        </p>
    `;
