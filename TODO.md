...
- [ ] Utiliser la méthode BEM pour les noms de classes ?
...
- [ ] Le bouton `reset` du setting peut devenir orphelin si le titre est trop long (espace insécable ne fonctionne pas).
